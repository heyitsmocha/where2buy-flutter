...
class ResponsiveBottomSheetScaffold extends StatelessWidget {
  ...
  /// The fraction of the screen height that the bottom sheet should take when the keyboard is not visible. The actual height will be this fraction plus the keyboard height when the keyboard is visible.
  /// 
